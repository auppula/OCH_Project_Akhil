...
The project consists of a web application for online competition hosting

it consists of the html css as front express js as backend node js as application server and my sql as database 

it consits of directroies 
node_modules - cosnsits of node files 
public - consists of css, img, js directores 
  css - consists of stylesheets
  img - consists of images 
  js - consists of javascript files 
view - consists of EJS files 
rest of the files are database, packages and tools

to start the project below steps to be followed. 
...
more commands for operating node js are mentioned below.
